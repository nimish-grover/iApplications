...
from iCore.app.models.user import UserModel
from .db import db
from flask_smorest import Api
from iCore.app.routes.auth import blp as AdminBlueprint
from iCore.app.routes.index import blp as indexBlueprint
